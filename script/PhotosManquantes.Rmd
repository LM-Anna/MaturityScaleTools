...
test6<-Dataphoto
test<- test6 %>% filter(Species=="Argyrosomus regius" | Species=="Chelidonichthys cuculus" | Species=="Clupea clupea" | Species=="Engraulis encrasicolus" | Species=="Dicentrarchus labrax" | Species=="Flat fish sp." | Species=="Gadidae sp." | Species=="Merluccius merluccius" | Species=="Mullus sp." | Species=="Lophius sp." | Species=="Pagellus bogaraveo" | Species=="Sardina pilchardus" | Species=="Scomber scombrus" | Species=="Scophthalmus sp." | Species=="Solea solea" | Species=="Sprattus sprattus")
colnames(test)[8]<-"ID"
