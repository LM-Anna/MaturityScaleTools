...
Dataphoto <- read_excel(paste0(path2localfile2,"photo_guides.xlsx"),sheet=1)#data frame with all gonads photos
Datascale <- read_excel(paste0(path2localfile2,"matu_scale.xlsx"),sheet=1)#data frame with files simple commentaries
