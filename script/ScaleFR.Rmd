...
#load reference data
Dataphoto <- read_excel(paste0(path2localfile,"photo_mat.xlsx"),sheet=2)#data frame with all gonads photos
Datascale <- read_excel(paste0(path2localfile,"matu_scale.xlsx"),sheet=1)#data frame with files simple commentaries
Datataille <- read_excel(paste0(path2localfile,"matu_scale.xlsx"),sheet=3)#data frame with first maturity size info
