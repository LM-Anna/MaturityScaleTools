...
mydata <- data.frame(Espèce =  paste(sppfr,spplat,sep=" / "),Fish=rep(imgspp,length(1)),Sex=rep(imgsex,length(1))) %>% 
...
TT2 <- flextable(mydata, col_keys = c("dummy","Fish","Sex")) %>%
  ...
  set_header_labels(dummy="MATURITE ECHELLE VISUELLE",Sex="",Fish="")%>%
...
```{r phaseE, echo=F, resultas='asis', warning=F, message=F,eval=T,fig.height=1.5,fig.width=7.5,out.width='400px', fig.align='center'}
...
```{r phaseF, echo=F, resultas='asis', warning=F, message=F,eval=T,fig.height=2.2,fig.width=7.5,out.width='550px',fig.align='center'}
...
```{r test4 , echo=F, warning=F, message=F,fig.height=2,fig.width=8.4,out.width='550px',fig.align='center'}
